...
export function ProfileInfo({ profile, onClanPress }: ProfileInfoProps) {
  return (
    <View className="px-6 pt-6 pb-4">
      ...
      <View className="flex-row gap-3 mb-4">
        ...
        {/* Clan Card */}
        <Pressable onPress={onClanPress} className="flex-1 bg-black rounded-xl p-4 active:opacity-70">
