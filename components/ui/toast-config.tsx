...
export const toastConfig = {
  ...
  error: (props: ToastProps) => (
    <View className="w-[90%] bg-black border-l-4 border-neutral-300 mt-12 p-5 flex-row items-start shadow-2xl">
  ...
  info: (props: ToastProps) => (
    <View className="w-[90%] bg-black border-l-4 border-neutral-500 mt-12  p-5 flex-row items-start shadow-2xl">
  ...
  warning: (props: ToastProps) => (
    <View className="w-[90%] bg-black border-l-4 border-neutral-400 mt-12 p-5 flex-row items-start shadow-2xl">
